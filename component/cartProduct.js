...
const dispatch = useDispatch()
  ...
  return (
    <div className='bg-slate-200 p-2 flex gap-4 rounded border border-slate-300'>
        ...
        <h3 className="font-semibold text-slate-600  capitalize text-2xl md:text-4xl ">{name}</h3>
        ...
        <p className=" text-slate-600  font-medium text-2xl">{category}</p>
        ...
        <div className='flex gap-3 items-center'>
          <button onClick={()=>dispatch(increaseQty(id))}  className="bg-slate-300 py-1 mt-2 rounded hover:bg-slate-400  text-2xl p-1"><TbPlus/></button>
